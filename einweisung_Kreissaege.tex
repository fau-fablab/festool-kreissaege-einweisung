...
\usepackage{float} % fuer H Option bei figures
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{festool_bilder_1Teil1.pdf}
	\caption{Foto der Schaltung und des fertigen Gehäuses}
	\label{fig:gehaeuse_oben}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{festool_bilder_1Teil2.pdf}
	\caption{Foto der Schaltung und des fertigen Gehäuses}
	\label{fig:gehaeuse_oben}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{festool_bilder_2Teil1.pdf}
	\caption{Foto der Schaltung und des fertigen Gehäuses}
	\label{fig:gehaeuse_oben}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{festool_bilder_2Teil2.pdf}
	\caption{Foto der Schaltung und des fertigen Gehäuses}
	\label{fig:gehaeuse_oben}
\end{figure}
...
\section{Quellen}
\begin{itemize}
\item Festool Bedienungsanleitung TS 55 REBQ
\end{itemize}
